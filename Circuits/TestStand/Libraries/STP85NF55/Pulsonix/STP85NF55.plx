...
//348746/1163709/2.50/3/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "STP85NF55" (originalName "STP85NF55")
	...
	(compDef "STP85NF55" (originalName "STP85NF55") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "STP85NF55"))
		...
		(attr "Mouser Part Number" "511-STP85NF55")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/STP85NF55?qs=mdiO5HdF0KgIATm5G3vEuw%3D%3D")
		(attr "Manufacturer_Name" "STMicroelectronics")
		(attr "Manufacturer_Part_Number" "STP85NF55")
		(attr "Description" "Automotive-grade N-channel 55 V, 0.0062 Ohm typ., 42 A, STripFET(TM) II Power MOSFET in TO-220 package")
		(attr "<Hyperlink>" "https://www.st.com/resource/en/datasheet/stb85nf55t4.pdf")
		(attr "<Component Height>" "4.6")
		(attr "<STEP Filename>" "STP85NF55.stp")
